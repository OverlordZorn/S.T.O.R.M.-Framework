...
class CVO_Weather_Sandstorm_01 : CVO_Weather_Default
{
    ...
    fog_value_max = 0.5;                            // 0..1   - Maximum Fog Level at 100% intensity
    fog_dispersion = 0.025;                         // 0..1   - Recommend to stay within 0 .. 0.1
    ...
    wind_value = 75;                                // Number - 0.. alot, eventhough +200 values getting cray cray
