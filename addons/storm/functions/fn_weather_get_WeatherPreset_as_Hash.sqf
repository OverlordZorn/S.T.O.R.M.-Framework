...
diag_log format ["[CVO][STORM](LOG)(fnc_weather_get_WeatherPreset_as_Hash) - _this : %1",_this];
...
// Create effect Array to be exported
{
    ...
    diag_log format ["[CVO][STORM](LOG)(fnc_weather_get_WeatherPreset_as_Hash) - _x - _value : %1 - %2",_x, _value];
