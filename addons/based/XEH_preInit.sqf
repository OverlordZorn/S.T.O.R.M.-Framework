...
[
    ...
    ["Enable Debug",  "Enable Debug Mode and Messages across the Mod"],                   // _title - Display name or display name + tooltip (optional, default: same as setting name) <STRING, ARRAY> - Pretty name shown inside the ingame settings menu. Can be stringtable entry.
    [MOD_NAME_BEAUTIFIED, "Main - Debug"],                                      //     _category    - Category for the settings menu + optional sub-category <STRING, ARRAY>
